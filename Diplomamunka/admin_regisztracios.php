...
<div id="centercg">
    ...
    <div id="popup" class="popup">
        <form id="popupform" method="post" action="admin_regisztracios.php">
        ...
        <input type="hidden" id="eredmeny" name="result" value="">
			<div id="ujfelhasznalo">
                <table>
                    ...
                    <tr class="rendeloiadatok">
                        <td class="rendelolabel"> <label class="rendelolabel">Email cím: </label></td>
...
<script>
    function ellenorizJelszo() {
        var felhasznalonev = document.querySelector('input[name="felhasznalonev"]').value;
        ...
        if (felhasznalonev.length < 8 || felhasznalonev.length > 16 || /[!'@#\$;,%\^&\*-]/.test(felhasznalonev)) {
            // Hibás formátum
            hibaUzenet +=('A felhasználónévnek 8-16 karakter hosszúnak kell lennie, és nem tartalmazhat speciális karaktereket: !\'@#\$;,%\^&\*-\n');
        }
            ...
            <table>
                ...
                if (mysqli_num_rows(mysqli_query($db->dbConnect(), $userCheck))) {
                    ...
                    <tr class='Elemek'>
                        ...
                        <td><input type='submit' value='Új jelszó beállítása' name='uj_jelszoG" . $row[0] . "'></td>
...
<script>
    ...
    function openPopup(event,ID) {
        ...
        document.getElementById('userInput').name = 'torlesadminG'+ID;
